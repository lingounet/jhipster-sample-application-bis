...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.ApplicationType.class.getName() + ".identities");
            ...
            createCache(cm, com.mycompany.myapp.domain.IcrfAssessment.class.getName());
            createCache(cm, com.mycompany.myapp.domain.IcrfAssessment.class.getName() + ".icrfs");
            ...
            createCache(cm, com.mycompany.myapp.domain.Identity.class.getName());
            createCache(cm, com.mycompany.myapp.domain.Identity.class.getName() + ".hostings");
            createCache(cm, com.mycompany.myapp.domain.Identity.class.getName() + ".personalData");
            createCache(cm, com.mycompany.myapp.domain.Identity.class.getName() + ".icrfs");
            createCache(cm, com.mycompany.myapp.domain.Identity.class.getName() + ".sensitiveData");
            createCache(cm, com.mycompany.myapp.domain.Identity.class.getName() + ".complementaryQuestions");
