...
public class SecurityInterview implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "securityInterview" }, allowSetters = true)
    @OneToOne(mappedBy = "securityInterview")
    private Psat psat;
    ...
    public void setApplicationTypes(Set<ApplicationType> applicationTypes) {
        if (this.applicationTypes != null) {
            this.applicationTypes.forEach(i -> i.setSecurityInterview(null));
        }
        if (applicationTypes != null) {
            applicationTypes.forEach(i -> i.setSecurityInterview(this));
        }
        this.applicationTypes = applicationTypes;
    }

    public SecurityInterview applicationTypes(Set<ApplicationType> applicationTypes) {
        this.setApplicationTypes(applicationTypes);
        return this;
    }

    public SecurityInterview addApplicationType(ApplicationType applicationType) {
        this.applicationTypes.add(applicationType);
        applicationType.setSecurityInterview(this);
        return this;
    }

    public SecurityInterview removeApplicationType(ApplicationType applicationType) {
        this.applicationTypes.remove(applicationType);
        applicationType.setSecurityInterview(null);
        return this;
    }
    ...
    public void setPsat(Psat psat) {
        if (this.psat != null) {
            this.psat.setSecurityInterview(null);
        }
        if (psat != null) {
            psat.setSecurityInterview(this);
        }
        this.psat = psat;
    }
