...
public class AvailabilityService {
    ...
    /**
     *  Get all the availabilities where Identity is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<Availability> findAllWhereIdentityIsNull() {
        log.debug("Request to get all availabilities where Identity is null");
        return StreamSupport
            .stream(availabilityRepository.findAll().spliterator(), false)
            .filter(availability -> availability.getIdentity() == null)
