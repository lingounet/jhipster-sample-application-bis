...
public class PsatService {
    ...
    /**
     *  Get all the psats where SecurityInterview is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<Psat> findAllWhereSecurityInterviewIsNull() {
        log.debug("Request to get all psats where SecurityInterview is null");
        return StreamSupport
            .stream(psatRepository.findAll().spliterator(), false)
            .filter(psat -> psat.getSecurityInterview() == null)
