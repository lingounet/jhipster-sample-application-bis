...
import com.mycompany.myapp.service.ComplementaryQuestionService;
...
public class ComplementaryQuestionResource {
    ...
    private final ComplementaryQuestionService complementaryQuestionService;

    private final ComplementaryQuestionRepository complementaryQuestionRepository;

    public ComplementaryQuestionResource(
        ComplementaryQuestionService complementaryQuestionService,
        ComplementaryQuestionRepository complementaryQuestionRepository
    ) {
        this.complementaryQuestionService = complementaryQuestionService;
    ...
    public ResponseEntity<ComplementaryQuestion> createComplementaryQuestion(@RequestBody ComplementaryQuestion complementaryQuestion)
        ...
        ComplementaryQuestion result = complementaryQuestionService.save(complementaryQuestion);
    ...
    public ResponseEntity<ComplementaryQuestion> updateComplementaryQuestion(
        ...
        ComplementaryQuestion result = complementaryQuestionService.update(complementaryQuestion);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<ComplementaryQuestion> partialUpdateComplementaryQuestion(
        ...
        Optional<ComplementaryQuestion> result = complementaryQuestionService.partialUpdate(complementaryQuestion);
    ...
    public List<ComplementaryQuestion> getAllComplementaryQuestions() {
        ...
        return complementaryQuestionService.findAll();
    }
    ...
    public ResponseEntity<ComplementaryQuestion> getComplementaryQuestion(@PathVariable Long id) {
        ...
        Optional<ComplementaryQuestion> complementaryQuestion = complementaryQuestionService.findOne(id);
    ...
    public ResponseEntity<Void> deleteComplementaryQuestion(@PathVariable Long id) {
        ...
        complementaryQuestionService.delete(id);
        return ResponseEntity
            .noContent()
