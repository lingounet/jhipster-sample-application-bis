...
import com.mycompany.myapp.service.HostingPlatformService;
...
public class HostingPlatformResource {
    ...
    private final HostingPlatformService hostingPlatformService;

    private final HostingPlatformRepository hostingPlatformRepository;

    public HostingPlatformResource(HostingPlatformService hostingPlatformService, HostingPlatformRepository hostingPlatformRepository) {
        this.hostingPlatformService = hostingPlatformService;
    ...
    public ResponseEntity<HostingPlatform> createHostingPlatform(@RequestBody HostingPlatform hostingPlatform) throws URISyntaxException {
        ...
        HostingPlatform result = hostingPlatformService.save(hostingPlatform);
    ...
    public ResponseEntity<HostingPlatform> updateHostingPlatform(
        ...
        HostingPlatform result = hostingPlatformService.update(hostingPlatform);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<HostingPlatform> partialUpdateHostingPlatform(
        ...
        Optional<HostingPlatform> result = hostingPlatformService.partialUpdate(hostingPlatform);
    ...
    public List<HostingPlatform> getAllHostingPlatforms() {
        ...
        return hostingPlatformService.findAll();
    }
    ...
    public ResponseEntity<HostingPlatform> getHostingPlatform(@PathVariable Long id) {
        ...
        Optional<HostingPlatform> hostingPlatform = hostingPlatformService.findOne(id);
    ...
    public ResponseEntity<Void> deleteHostingPlatform(@PathVariable Long id) {
        ...
        hostingPlatformService.delete(id);
        return ResponseEntity
            .noContent()
