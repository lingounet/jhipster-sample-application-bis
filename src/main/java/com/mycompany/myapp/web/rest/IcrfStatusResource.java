...
import com.mycompany.myapp.service.IcrfStatusService;
...
public class IcrfStatusResource {
    ...
    private final IcrfStatusService icrfStatusService;

    private final IcrfStatusRepository icrfStatusRepository;

    public IcrfStatusResource(IcrfStatusService icrfStatusService, IcrfStatusRepository icrfStatusRepository) {
        this.icrfStatusService = icrfStatusService;
    ...
    public ResponseEntity<IcrfStatus> createIcrfStatus(@RequestBody IcrfStatus icrfStatus) throws URISyntaxException {
        ...
        IcrfStatus result = icrfStatusService.save(icrfStatus);
    ...
    public ResponseEntity<IcrfStatus> updateIcrfStatus(
        ...
        IcrfStatus result = icrfStatusService.update(icrfStatus);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<IcrfStatus> partialUpdateIcrfStatus(
        ...
        Optional<IcrfStatus> result = icrfStatusService.partialUpdate(icrfStatus);
    ...
    public List<IcrfStatus> getAllIcrfStatuses(@RequestParam(required = false) String filter) {
        if ("icrf-is-null".equals(filter)) {
            ...
            return icrfStatusService.findAllWhereIcrfIsNull();
        }
        log.debug("REST request to get all IcrfStatuses");
        return icrfStatusService.findAll();
    }
    ...
    public ResponseEntity<IcrfStatus> getIcrfStatus(@PathVariable Long id) {
        ...
        Optional<IcrfStatus> icrfStatus = icrfStatusService.findOne(id);
