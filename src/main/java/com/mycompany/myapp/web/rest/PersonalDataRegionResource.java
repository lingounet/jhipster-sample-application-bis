...
public class PersonalDataRegionResource {
    ...
    public PersonalDataRegionResource(PersonalDataRegionRepository personalDataRegionRepository) {
    ...
    public ResponseEntity<PersonalDataRegion> createPersonalDataRegion(@RequestBody PersonalDataRegion personalDataRegion)
        ...
        PersonalDataRegion result = personalDataRegionRepository.save(personalDataRegion);
    ...
    public ResponseEntity<PersonalDataRegion> partialUpdatePersonalDataRegion(
        ...
        Optional<PersonalDataRegion> result = personalDataRegionRepository
    ...
    public ResponseEntity<PersonalDataRegion> getPersonalDataRegion(@PathVariable Long id) {
        ...
        Optional<PersonalDataRegion> personalDataRegion = personalDataRegionRepository.findById(id);
