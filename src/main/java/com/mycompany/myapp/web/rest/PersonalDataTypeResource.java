...
public class PersonalDataTypeResource {
    ...
    public PersonalDataTypeResource(PersonalDataTypeRepository personalDataTypeRepository) {
    ...
    public ResponseEntity<PersonalDataType> createPersonalDataType(@RequestBody PersonalDataType personalDataType)
        ...
        PersonalDataType result = personalDataTypeRepository.save(personalDataType);
    ...
    public ResponseEntity<PersonalDataType> partialUpdatePersonalDataType(
        ...
        Optional<PersonalDataType> result = personalDataTypeRepository
