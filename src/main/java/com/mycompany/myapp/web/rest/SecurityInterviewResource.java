...
public class SecurityInterviewResource {
    ...
    public ResponseEntity<SecurityInterview> createSecurityInterview(@Valid @RequestBody SecurityInterview securityInterview)
    ...
    public ResponseEntity<SecurityInterview> updateSecurityInterview(
        ...
        @Valid @RequestBody SecurityInterview securityInterview
    ) throws URISyntaxException {
    ...
    public ResponseEntity<SecurityInterview> partialUpdateSecurityInterview(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody SecurityInterview securityInterview
    ) throws URISyntaxException {
    ...
    public List<SecurityInterview> getAllSecurityInterviews(@RequestParam(required = false) String filter) {
        if ("applicationtype-is-null".equals(filter)) {
            log.debug("REST request to get all SecurityInterviews where applicationType is null");
            return securityInterviewService.findAllWhereApplicationTypeIsNull();
        }
