...
public class SecurityInterviewResource {
    ...
    public SecurityInterviewResource(SecurityInterviewRepository securityInterviewRepository) {
    ...
    public ResponseEntity<SecurityInterview> createSecurityInterview(@RequestBody SecurityInterview securityInterview)
        ...
        SecurityInterview result = securityInterviewRepository.save(securityInterview);
    ...
    public ResponseEntity<SecurityInterview> partialUpdateSecurityInterview(
        ...
        Optional<SecurityInterview> result = securityInterviewRepository
    ...
    public ResponseEntity<SecurityInterview> getSecurityInterview(@PathVariable Long id) {
        ...
        Optional<SecurityInterview> securityInterview = securityInterviewRepository.findById(id);
