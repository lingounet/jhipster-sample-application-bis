...
public class SensitiveDataTypeResource {
    ...
    public SensitiveDataTypeResource(SensitiveDataTypeRepository sensitiveDataTypeRepository) {
    ...
    public ResponseEntity<SensitiveDataType> createSensitiveDataType(@RequestBody SensitiveDataType sensitiveDataType)
        ...
        SensitiveDataType result = sensitiveDataTypeRepository.save(sensitiveDataType);
    ...
    public ResponseEntity<SensitiveDataType> partialUpdateSensitiveDataType(
        ...
        Optional<SensitiveDataType> result = sensitiveDataTypeRepository
    ...
    public ResponseEntity<SensitiveDataType> getSensitiveDataType(@PathVariable Long id) {
        ...
        Optional<SensitiveDataType> sensitiveDataType = sensitiveDataTypeRepository.findById(id);
