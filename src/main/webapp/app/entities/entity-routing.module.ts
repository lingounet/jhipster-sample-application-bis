...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'icrf-status',
        data: { pageTitle: 'jhipsterSampleApplicationBisApp.icrfStatus.home.title' },
        loadChildren: () => import('./icrf-status/icrf-status.module').then(m => m.IcrfStatusModule),
      },
      {
        path: 'icrf',
      ...
      {
        path: 'security-interview',
        data: { pageTitle: 'jhipsterSampleApplicationBisApp.securityInterview.home.title' },
        loadChildren: () => import('./security-interview/security-interview.module').then(m => m.SecurityInterviewModule),
      },
      {
        path: 'hosting',
