...
describe('SecurityInterview Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call ApplicationType query and add missing value', () => {
      const securityInterview: ISecurityInterview = { id: 456 };
      const applicationType: IApplicationType = { id: 83088 };
      securityInterview.applicationType = applicationType;

      const applicationTypeCollection: IApplicationType[] = [{ id: 93570 }];
    ...
    it('Should update editForm', () => {
      ...
      securityInterview.availability = availability;
      const applicationType: IApplicationType = { id: 63592 };
      securityInterview.applicationType = applicationType;
